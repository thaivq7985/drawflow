...
class Drawflow {
    constructor(container, render = null, parent = null) {
        ...
        // custom functions
        this.deleteNodeFuc = null;
        this.deleteConnectionFuc = null;
        // edit function
        this.editNodeFuc = null;
        this.editConnectionFuc = null;
    }
    ...
    click(e) {
        ...
        else if (e.target.closest('div.drawflow-delete')) {
            this.ele_selected = e.target.closest('div.drawflow-delete');
        }
        else {
            ...
            case 'drawflow-delete':
                if (e.target.tagName == 'path' || e.target.tagName == 'svg') {
                    ...
                    if (parentId == 'editButton') {
                        // do edit function
                        if (this.node_selected && this.editNodeFuc != null) {
                            this.editNodeFuc();
                        } else if (this.connection_selected && this.editConnectionFuc != null) {
                            this.editConnectionFuc();
                        }
                    } else {
                        // do delete function
                        if (this.node_selected) {
                            if (this.deleteNodeFuc != null) {
                                this.deleteNodeFuc();
                            } else {
                        ...
                        if (this.connection_selected) {
                            if (this.deleteConnectionFuc != null) {
                                this.deleteConnectionFuc();
                            } else {
                ...
                // remove the box 
                this.removeElementBox('drawflow-delete');
    ...
    contextmenu(e) {
        ...
        if (this.node_selected || this.connection_selected) {
            ...
            deletebox.innerHTML = `
                <i id="editButton" class="fa fa-edit"></i>&nbsp;
    ...
    removeElementBox(elementSelector) {
        if(this.precanvas.getElementsByClassName(elementSelector).length) {
          this.precanvas.getElementsByClassName(elementSelector)[0].remove()
        };
    }
}